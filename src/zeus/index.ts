...
export type ValueTypes = {
	...
	["Query"]: AliasType<{
search?: [{	query:string},ValueTypes["QuestionsResponse"]],
question?: [{	_id:string},ValueTypes["Question"]],
		__typename?: true
}>;
...
postQuestion?: [{	createQuestion:ValueTypes["CreateQuestion"]},true],
postAnswer?: [{	createAnswer:ValueTypes["CreateAnswer"]},true],
vote?: [{	_id:string},true],
		__typename?: true
}>;
	["PublicMutation"]: AliasType<{
login?: [{	login:ValueTypes["Login"]},true],
validateOtp?: [{	validateOTP:ValueTypes["ValidateOTP"]},true],
		__typename?: true
}>;
	["Login"]: {
	username:string,
...
export type ModelTypes = {
	...
	["StringId"]: ModelTypes["Question"] | ModelTypes["Answer"];
	["Question"]: {
		content:string,
	score:number,
	_id:string,
	answers:ModelTypes["Answer"][],
	title:string,
	createdAt:string,
	updatedAt:string,
	...
	["Query"]: {
		search:ModelTypes["QuestionsResponse"][],
	question?:ModelTypes["Question"]
};
	["QuestionsResponse"]: {
		question:ModelTypes["Question"],
	bestAnswer?:ModelTypes["Answer"]
};
	["Mutation"]: {
	...
	["Login"]: GraphQLTypes["Login"];
	["ValidateOTP"]: GraphQLTypes["ValidateOTP"];
	["ToAnswer"]:ModelTypes["Question"] | ModelTypes["Answer"];
	["User"]: {
		username:string
};
	["CreateQuestion"]: GraphQLTypes["CreateQuestion"];
	["CreateAnswer"]: GraphQLTypes["CreateAnswer"];
	["Dated"]: ModelTypes["Question"] | ModelTypes["Answer"];
	["Owned"]: ModelTypes["Question"] | ModelTypes["Answer"]
    }
...
export type GraphQLTypes = {
	...
	question: GraphQLTypes["Question"],
	bestAnswer?: GraphQLTypes["Answer"]
};
	["Mutation"]: {
	__typename: "Mutation",
